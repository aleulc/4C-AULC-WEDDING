      ...
      <div class="row g-4 align-items-center">
         ...
         <div class="col-lg-6 wow fadeInUp" data-wow-duration="4s">
            <div class="right__content">
               ...
               <p>
                  The purpose of invitation should be clear. The name of the honoree must be mentioned. The event date
                  and time must be written in letters, do not use abbreviations. Venue Name and Venue's Full Address are
                  important.Write the date of your party, including the date and day of the week. Your invitation also
                  needs to tell your guests what time to arrive and approximate or definite.
               </p>
               <p class="p__cont mt-3">
                  Few classic color options remain a top choice for brides across the decades as blue. In addition to
                  this color being what some call a good luck charm for the day, it's also a color that symbolized
                  royalty. In addition to this color being what some call a good luck charm for the day, it's also a
